...
<section>
	...
	<div id="container">
		...
		<c:if test="${Type == 2}">	
			<table>
				<tr>
					<th colspan="5">${cVo.kVo.kName}<fmt:formatDate value="${cVo.kVo.kDate}" pattern="(yyyy)"/> ${cVo.cName}</th>
				</tr>
				<tr>
					<th>
...
<script>
	...
	$("#admit").click(function() {
		...
		$.ajax({
			url: "${pageContext.request.contextPath}/teacher/admitP/${cVo.cNo}",
			type: "post",
	...
	$("#refuse").click(function() {		
		...
		$.ajax({
			url: "${pageContext.request.contextPath}/teacher/refuseP/${cVo.cNo}",
			type: "post",
