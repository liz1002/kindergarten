		...
		<form action="addKinder" method="post">	
			<fieldset>
				...
				<p>
					...
					<input type="text" name="kVo.kName" data-msg="이름을 입력하세요." placeholder="예) 가나다유치원" maxlength="20">
				</p>
				<p class="tel">
				...
				<p id="addr2">
					...
					<input type="text" name="kVo.kLastaddr" class="form-control userSecondAddr" id="userSecondAddr" placeholder="상세 주소를 입력해주세요"/>
				</p>
			...
			<fieldset>
				...
				<p>
					...
					<input type="text" name="dNickname" data-msg="별명을 입력하세요." placeholder="최대 10글자" maxlength="10"><br>
					<span id="coment">[예시] 가나다 원장, 타카하 유치원 원장 등</span>
				</p>
